const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RunDataJsonActions-SQqaiBEP.js","assets/index-DD7Wuhk5.js","assets/index-DJ205bL0.css","assets/_commonjs-dynamic-modules-TGKdzP3c.js","assets/RunDataJsonActions-DrgwFS0W.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, au as useNDVStore, r as ref, ii as useElementSize, q as computed, hw as executionDataToJson, i as createElementBlock, g as openBlock, e as createBlock, j as createVNode, w as withCtx, f as createCommentVNode, m as unref, bZ as defineAsyncComponent, bY as Suspense, ic as TextWithHighlights, n as normalizeClass, id as MappingPill, ho as Draggable, aq as __vitePreload, v as shorten, ih as getMappedExpression, ij as isString, ik as nonExistingJsonPath, aR as useExternalHooks, ai as useTelemetry, _ as _export_sfc } from "./index-DD7Wuhk5.js";
import { V as VueJsonPretty } from "./NodeDetailsView-CmtK-rDD.js";
import "./import-curl-C6ERUxFe.js";
import "./FileSaver.min-Bs2qHlKb.js";
import "./RunDataAi-B_EadpzG.js";
import "./useCanvasOperations-DCaSrD1N.js";
import "./useExecutionHelpers-BVY9xXbG.js";
import "./dateFormatter-C7xnNKzY.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const LazyRunDataJsonActions = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataJsonActions-SQqaiBEP.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0)
    );
    const props = __props;
