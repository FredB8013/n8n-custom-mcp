...
/* BEM
 -------------------------- */
.webhooks[data-v-08694311] {
  padding-bottom: var(--spacing-xs);
  margin: var(--spacing-xs) 0;
  border-bottom: 1px solid var(--color-text-lighter);
}
.webhooks .headline[data-v-08694311] {
  color: var(--color-primary);
  font-weight: var(--font-weight-bold);
  font-size: var(--font-size-2xs);
}
.http-field[data-v-08694311] {
  position: absolute;
  width: 50px;
  display: inline-block;
  top: calc(50% - 8px);
}
.http-method[data-v-08694311] {
...
.minimize-icon[data-v-08694311] {
  font-size: 1.3em;
  margin-right: 0.5em;
}
.mode-selection-headline[data-v-08694311] {
  line-height: 1.8em;
}
.node-webhooks[data-v-08694311] {
  margin-left: 1em;
}
.url-field[data-v-08694311] {
  display: inline-block;
  width: calc(100% - 60px);
  margin-left: 55px;
}
.url-field-full-width[data-v-08694311] {
  display: inline-block;
  margin: 5px 10px;
}
.url-selection[data-v-08694311] {
  margin-top: var(--spacing-xs);
}
.minimize-button[data-v-08694311] {
  display: inline-block;
  transition-duration: 0.5s;
  transition-property: transform;
}
.expanded .minimize-button[data-v-08694311] {
  transform: rotate(90deg);
}
.webhook-url[data-v-08694311] {
  position: relative;
  top: 0;
  width: 100%;
  font-size: var(--font-size-2xs);
...
.webhook-wrapper[data-v-08694311] {
  line-height: 1.5;
  position: relative;
  margin-top: var(--spacing-xs);
