...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const LazyNodeCreation = defineAsyncComponent(
      async () => await __vitePreload(() => import("./NodeCreation-BgW5u-Bc.js").then((n) => n.N), true ? __vite__mapDeps([0,1,2,3,4]) : void 0)
    );
    const LazyNodeDetailsView = defineAsyncComponent(
      async () => await __vitePreload(() => import("./NodeDetailsView-CmtK-rDD.js").then((n) => n.N), true ? __vite__mapDeps([5,1,2,6,7,8,3,9,10,11,12,13]) : void 0)
    );
    const LazySetupWorkflowCredentialsButton = defineAsyncComponent(
      async () => await __vitePreload(() => import("./SetupWorkflowCredentialsButton-BEq2gs_-.js"), true ? __vite__mapDeps([14,1,2]) : void 0)
    );
    const $style = useCssModule();
