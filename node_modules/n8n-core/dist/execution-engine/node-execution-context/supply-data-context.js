...
class SupplyDataContext extends base_execute_context_1.BaseExecuteContext {
    ...
    cloneWith(replacements) {
        const context = new SupplyDataContext(this.workflow, this.node, this.additionalData, this.mode, this.runExecutionData, replacements.runIndex, this.connectionInputData, {}, this.connectionType, this.executeData, this.closeFunctions, this.abortSignal);
