...
], InsightsConfig.prototype, "compactionIntervalMinutes", void 0);
__decorate([
    (0, config_1.Env)('N8N_INSIGHTS_COMPACTION_BATCH_SIZE'),
    __metadata("design:type", Number)
], InsightsConfig.prototype, "compactionBatchSize", void 0);
__decorate([
    (0, config_1.Env)('N8N_INSIGHTS_COMPACTION_HOURLY_TO_DAILY_THRESHOLD_DAYS'),
    __metadata("design:type", Number)
], InsightsConfig.prototype, "compactionHourlyToDailyThresholdDays", void 0);
__decorate([
    (0, config_1.Env)('N8N_INSIGHTS_COMPACTION_DAILY_TO_WEEKLY_THRESHOLD_DAYS'),
    __metadata("design:type", Number)
], InsightsConfig.prototype, "compactionDailyToWeeklyThresholdDays", void 0);
exports.InsightsConfig = InsightsConfig = __decorate([
    config_1.Config
], InsightsConfig);
